...
class Model(object):
    ...
    def NegState(self, lastSeen, lastTime, newTime):
        """Return a state representing a negative observation at time step newTime, with
        the last positive observation being lastSeen at lastTime"""
        raise NotImplementedError()
