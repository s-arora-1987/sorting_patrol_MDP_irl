...
if __name__ == "__main__": 
	...
	params_pickinspect_manualTuning = [ 0.10, 0.0, 0.0, 0.22, -0.12, 0.44, 0.0, -0.12] 
	...
	params = params_pickinspect_manualTuning 
	norm_params = [float(i)/sum(np.absolute(params)) for i in params]
	print "norm_params pick inspect:"+str(norm_params)
	...
	params_rolling_14dim = [1,-0.5,-0.75,1.3,0,-0.2,0,0,0,1.88,0,0,0,-1.0] 

	params_rolling_manualTuning = [0.15082956259426847, -0.075414781297134234, -0.11312217194570136, 
	...
	# params = params_rolling_reward2
	# params_rolling_prashant = [1,-0.5,1.3,-0.75,-0.2,0,1.88,-1.0] 
	# params = params_rolling_prashant

	params_irloutput_rolling = [6.8854e-09, 1.87884e-09, 3.5755e-09, 0.194948, 2.67527e-34,\
	0.0286509, 0.776401, 2.0002e-10]
	params = params_rolling_manualTuning

	norm_params = [float(i)/sum(np.absolute(params)) for i in params]
	print "norm_params rolling:"+str(norm_params)
